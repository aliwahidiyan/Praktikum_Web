...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 19 Okt 2023 pada 15.31
...
INSERT INTO `menu` (`id_menu`, `nama`, `harga`, `deskripsi`) VALUES
(1, 'Kue Cokelat', 25000, 'Kue cokelat lembut dengan lapisan cokelat krim'),
(2, 'Pancake Blueberry', 30000, 'Pancake lembut dengan blueberry segar dan sirup maple'),
...
(12, 'Pancake Cokelat', 30000, 'Pancake lembut dengan cokelat chips');
