...
if (isset($_POST["kirim"])) {
    ...
    if (strlen($no_hp) < 12) {
        ...
        $query = mysqli_query($conn, "UPDATE transaksi SET id_menu = $nama_dessert, nama_pelanggan = '$nama', no_hp = '$no_hp', jumlah = $jumlah, tanggal = '$tanggal_pesan', total_harga = $total");
        if ($query) {
            echo "
            <script>
